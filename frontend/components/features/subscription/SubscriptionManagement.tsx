          ...
          {activeSubscription.cancelled_at && (
            <div className="p-4 bg-white dark:bg-gray-700 bg-opacity-20 dark:bg-opacity-40 rounded-lg">
              <p className="text-sm">
                ...
                Your subscription was cancelled on {new Date(activeSubscription.cancelled_at).toLocaleDateString()}.
                You will retain access until {activeSubscription.expires_at && new Date(activeSubscription.expires_at).toLocaleDateString()}.
              </p>
            </div>
          )}
        </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid sm:grid-cols-2 gap-x-6 gap-y-2 text-sm text-gray-600">
                      <div>
                        ...
                        ${subscription.plan_price || 0}/{subscription.billing_period || 'month'}
                      </div>
                      <div>
