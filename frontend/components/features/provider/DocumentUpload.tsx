...
export function DocumentUpload({ providerId, onUploadSuccess }: DocumentUploadProps) {
	...
	return (
		<div className='bg-white rounded-lg shadow-md p-6 max-w-2xl mx-auto'>
			...
			{/* File Upload Area */}
			<div className='mb-6'>
				<label className='block text-sm font-medium text-gray-700 mb-2'>Upload File * (PDF, JPG, PNG - Max 5MB)</label>
				...
				{!file ?
					<div
						...
						:	<>
								<p className='text-gray-600 mb-2'>Drag & drop your document here, or click to select</p>
			...
			<div className='mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg'>
				<p className='text-sm text-blue-800'>
					<strong>Note:</strong> Your document will be reviewed by our team within 24-48 hours. You'll receive a
					notification once it's verified.
				</p>
			</div>
		</div>
	);
